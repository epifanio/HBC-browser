...
class SaveKml(QWidget, Ui_Form):
    def __init__(self, parent=None):
        ...
        self.addlink.clicked.connect(self.addlinkf)
    ...
    @pyqtSlot(str)    
    def from_main_signal(self, message):
        self.currentimagestring = message
        print(message)  
        
    def filemanager(self):
        filemanager = self.settings['settings']['filemanager']
        kmldir = self.settings['settings']['export']['kmldir']
    ...
    def addlinkf(self):
        ...
        self.description.verticalScrollBar().setValue(self.description.verticalScrollBar().maximum())
    ...
    def savekml(self):
        ...
        tessellate = 0
        extrude = 0
        kmldirectory = self.settings['settings']['export']['kmldir']
        ...
        pnt.coords = [(self.longitude.text(), self.latitude.text(), self.Offset.value())] 
        ...
        pnt.style = style
        pnt.description=self.description.toHtml()
        pnt.extrude = extrude
